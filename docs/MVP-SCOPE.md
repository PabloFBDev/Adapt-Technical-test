...
Funcionalidades exigidas pelo teste técnico.
...
Supabase dá Postgres hosted sem Docker. Prisma dá migrations explícitas, type-safety e é o ORM mais comum no ecossistema Next.js. O schema é declarativo e as migrations são versionadas no git.

**Por que NextAuth Credentials?**
É a solução mais robusta dentre as opções permitidas. Tem session handling, CSRF protection, e JWT built-in. Credentials provider é direto e bem documentado no ecossistema Next.js.
